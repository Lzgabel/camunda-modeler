...
function Animation(canvas, eventBus, scopeFilter) {
  ...
  eventBus.on('import.done', () => {
    const draw = svg_js__WEBPACK_IMPORTED_MODULE_0___default()(canvas._svg);

    const viewport = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.query)('.viewport', canvas._svg);

    const groupParent = svg_js__WEBPACK_IMPORTED_MODULE_0___default().adopt(viewport);
  ...
  eventBus.on(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.RESET_SIMULATION_EVENT, () => {
  ...
  eventBus.on(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.PAUSE_SIMULATION_EVENT, () => {
    this._animations.forEach(animation => {
      animation.pause();
    });
  });

  eventBus.on(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.PLAY_SIMULATION_EVENT, () => {
    this._animations.forEach(animation => {
      animation.play();
    });
  });
...
Animation.prototype.createAnimation = function(connection, scope, done=noop) {
  ...
  this._eventBus.fire(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.ANIMATION_CREATED_EVENT, {
    animation
  });
...
Animation.prototype.setAnimationSpeed = function(speed) {
  ...
  this._eventBus.fire(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.ANIMATION_SPEED_CHANGED_EVENT, {
    speed
  });
};
...
inherits__WEBPACK_IMPORTED_MODULE_1___default()(AnimatedMessageFlowBehavior, _simulator_behaviors_MessageFlowBehavior__WEBPACK_IMPORTED_MODULE_0__.default);
...
inherits__WEBPACK_IMPORTED_MODULE_1___default()(AnimatedSequenceFlowBehavior, _simulator_behaviors_SequenceFlowBehavior__WEBPACK_IMPORTED_MODULE_0__.default);
...
/* harmony export */ });
/* harmony import */ var _AnimatedMessageFlowBehavior__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AnimatedMessageFlowBehavior */ "./node_modules/bpmn-js-token-simulation/lib/animation/behaviors/AnimatedMessageFlowBehavior.js");
/* harmony import */ var _AnimatedSequenceFlowBehavior__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AnimatedSequenceFlowBehavior */ "./node_modules/bpmn-js-token-simulation/lib/animation/behaviors/AnimatedSequenceFlowBehavior.js");



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  sequenceFlowBehavior: [ 'type', _AnimatedSequenceFlowBehavior__WEBPACK_IMPORTED_MODULE_1__.default ],
  messageFlowBehavior: [ 'type', _AnimatedMessageFlowBehavior__WEBPACK_IMPORTED_MODULE_0__.default ]
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _behaviors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./behaviors */ "./node_modules/bpmn-js-token-simulation/lib/animation/behaviors/index.js");
/* harmony import */ var _features_scope_filter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../features/scope-filter */ "./node_modules/bpmn-js-token-simulation/lib/features/scope-filter/index.js");
/* harmony import */ var _simulator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../simulator */ "./node_modules/bpmn-js-token-simulation/lib/simulator/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  __depends__: [
    _simulator__WEBPACK_IMPORTED_MODULE_2__.default,
    _behaviors__WEBPACK_IMPORTED_MODULE_0__.default,
    _features_scope_filter__WEBPACK_IMPORTED_MODULE_1__.default
  ],
...
/* harmony import */ var _features_palette__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_features_palette__WEBPACK_IMPORTED_MODULE_14__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  'exclusiveGatewaySettings': [ 'type', _features_exclusive_gateway_settings__WEBPACK_IMPORTED_MODULE_12__.default ],
  'preserveElementColors': [ 'type', _features_preserve_element_colors__WEBPACK_IMPORTED_MODULE_13__.default ],
  'tokenSimulationPalette': [ 'type', (_features_palette__WEBPACK_IMPORTED_MODULE_14___default()) ]
});
...
/* harmony import */ var _handler_BoundaryEventHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./handler/BoundaryEventHandler */ "./node_modules/bpmn-js-token-simulation/lib/features/context-pads/handler/BoundaryEventHandler.js");
/* harmony import */ var _handler_ExclusiveGatewayHandler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./handler/ExclusiveGatewayHandler */ "./node_modules/bpmn-js-token-simulation/lib/features/context-pads/handler/ExclusiveGatewayHandler.js");
/* harmony import */ var _handler_EventBasedGatewayHandler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./handler/EventBasedGatewayHandler */ "./node_modules/bpmn-js-token-simulation/lib/features/context-pads/handler/EventBasedGatewayHandler.js");
/* harmony import */ var _handler_IntermediateCatchEventHandler__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./handler/IntermediateCatchEventHandler */ "./node_modules/bpmn-js-token-simulation/lib/features/context-pads/handler/IntermediateCatchEventHandler.js");
/* harmony import */ var _handler_StartEventHandler__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./handler/StartEventHandler */ "./node_modules/bpmn-js-token-simulation/lib/features/context-pads/handler/StartEventHandler.js");
...
function ContextPads(
  ...
  this.registerHandler('bpmn:ExclusiveGateway', _handler_ExclusiveGatewayHandler__WEBPACK_IMPORTED_MODULE_3__.default);
  this.registerHandler('bpmn:IntermediateCatchEvent', _handler_IntermediateCatchEventHandler__WEBPACK_IMPORTED_MODULE_5__.default);
  this.registerHandler('bpmn:Activity', _handler_IntermediateCatchEventHandler__WEBPACK_IMPORTED_MODULE_5__.default);

  this.registerHandler('bpmn:EventBasedGateway', _handler_EventBasedGatewayHandler__WEBPACK_IMPORTED_MODULE_4__.default);

  // TODO(nikku): restore or delete
  // this.registerHandler('bpmn:SubProcess', ProcessHandler);

  this.registerHandler('bpmn:Activity', _handler_BoundaryEventHandler__WEBPACK_IMPORTED_MODULE_2__.default);

  this.registerHandler('bpmn:Process', _handler_StartEventHandler__WEBPACK_IMPORTED_MODULE_6__.default);
  this.registerHandler('bpmn:SubProcess', _handler_StartEventHandler__WEBPACK_IMPORTED_MODULE_6__.default);
  this.registerHandler('bpmn:Participant', _handler_StartEventHandler__WEBPACK_IMPORTED_MODULE_6__.default);

  eventBus.on(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.TOGGLE_MODE_EVENT, LOW_PRIORITY, context => {
  ...
  eventBus.on(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.RESET_SIMULATION_EVENT, LOW_PRIORITY, () => {
    this.closeContextPads();
    this.openContextPads();
  });
  ...
  eventBus.on(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.SCOPE_FILTER_CHANGED_EVENT, event => {
    ...
    const contextPads = (0,min_dom__WEBPACK_IMPORTED_MODULE_7__.queryAll)(
  ...
  eventBus.on(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.ELEMENT_CHANGED_EVENT, LOW_PRIORITY, event => {
    const {
      element
    } = event;
...
ContextPads.prototype.getHandlers = function(element) {
  ...
  return (
    this._handlers.filter(
      ({ type }) => (0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, type)
    ).map(
      ({ handler }) => handler
    )
  );
...
ContextPads.prototype.openElementContextPads = function(element) {
  ...
  for (const contextPad of contextPads) {
    ...
    if (contextPad.scopes) {
      ...
      (0,min_dom__WEBPACK_IMPORTED_MODULE_7__.classes)(contextPad.html).toggle('hidden', shownScopes.length === 0);
    }

    if ('action' in contextPad) {

      min_dom__WEBPACK_IMPORTED_MODULE_7__.event.bind(contextPad.html, 'click', event => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ContextPads__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ContextPads */ "./node_modules/bpmn-js-token-simulation/lib/features/context-pads/ContextPads.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  contextPads: [ 'type', _ContextPads__WEBPACK_IMPORTED_MODULE_0__.default ]
});
...
ElementSupport.prototype.enable = function() {
  ...
  this._elementRegistry.forEach(element => {
    ...
    if (!(0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, UNSUPPORTED_ELEMENTS)) {
      return;
    }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ElementSupport__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ElementSupport */ "./node_modules/bpmn-js-token-simulation/lib/features/element-support/ElementSupport.js");
/* harmony import */ var _element_notifications__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../element-notifications */ "./node_modules/bpmn-js-token-simulation/lib/features/element-notifications/index.js");
/* harmony import */ var _notifications__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../notifications */ "./node_modules/bpmn-js-token-simulation/lib/features/notifications/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  __depends__: [
    _element_notifications__WEBPACK_IMPORTED_MODULE_1__.default,
    _notifications__WEBPACK_IMPORTED_MODULE_2__.default
  ],
  __init__: [ 'elementSupport' ],
  elementSupport: [ 'type', _ElementSupport__WEBPACK_IMPORTED_MODULE_0__.default ]
});
...
function Log(
  ...
  eventBus.on(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.SCOPE_DESTROYED_EVENT, event => {
    ...
    const isSubProcess = (0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(scopeElement, 'bpmn:SubProcess');
  ...
  eventBus.on(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.TRACE_EVENT, event => {
    ...
    if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:BusinessRuleTask')) {
      this.log({
        text: elementName || 'Business Rule Task',
        icon: 'bpmn-icon-business-rule',
        scope
      });
    } else if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:CallActivity')) {
      this.log({
        text: elementName || 'Call Activity',
        icon: 'bpmn-icon-call-activity',
        scope
      });
    } else if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:IntermediateCatchEvent') || (0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:IntermediateThrowEvent')) {
      this.log({
        text: elementName || 'Intermediate Event',
        icon: 'bpmn-icon-intermediate-event-none',
        scope
      });
    } if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:BoundaryEvent')) {
      this.log({
        text: elementName || 'Boundary Event',
        icon: 'bpmn-icon-intermediate-event-none',
        scope
      });
    } else if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:ManualTask')) {
      this.log({
        text: elementName || 'Manual Task',
        icon: 'bpmn-icon-manual',
        scope
      });
    } else if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:ScriptTask')) {
      this.log({
        text: elementName || 'Script Task',
        icon: 'bpmn-icon-script',
        scope
      });
    } else if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:ServiceTask')) {
      this.log({
        text: elementName || 'Service Task',
        icon: 'bpmn-icon-service',
        scope
      });
    } else if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:Task')) {
      this.log({
        text: elementName || 'Task',
        icon: 'bpmn-icon-task',
        scope
      });
    } else if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:UserTask')) {
      this.log({
        text: elementName || 'User Task',
        icon: 'bpmn-icon-user',
        scope
      });
    } else if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:ExclusiveGateway')) {
    ...
    } else if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:EndEvent')) {
      if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.isTypedEvent)((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.getBusinessObject)(element), 'bpmn:TerminateEventDefinition')) {
        this.log({
    ...
    } else if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:StartEvent')) {
      this.log({
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Log */ "./node_modules/bpmn-js-token-simulation/lib/features/log/Log.js");
/* harmony import */ var _scope_filter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../scope-filter */ "./node_modules/bpmn-js-token-simulation/lib/features/scope-filter/index.js");
/* harmony import */ var _notifications__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../notifications */ "./node_modules/bpmn-js-token-simulation/lib/features/notifications/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  log: [ 'type', _Log__WEBPACK_IMPORTED_MODULE_0__.default ]
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _PauseSimulation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PauseSimulation */ "./node_modules/bpmn-js-token-simulation/lib/features/pause-simulation/PauseSimulation.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  pauseSimulation: [ 'type', _PauseSimulation__WEBPACK_IMPORTED_MODULE_0__.default ]
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ResetSimulation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ResetSimulation */ "./node_modules/bpmn-js-token-simulation/lib/features/reset-simulation/ResetSimulation.js");
/* harmony import */ var _notifications__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../notifications */ "./node_modules/bpmn-js-token-simulation/lib/features/notifications/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  resetSimulation: [ 'type', _ResetSimulation__WEBPACK_IMPORTED_MODULE_0__.default ]
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ShowScopes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ShowScopes */ "./node_modules/bpmn-js-token-simulation/lib/features/show-scopes/ShowScopes.js");
/* harmony import */ var _scope_filter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../scope-filter */ "./node_modules/bpmn-js-token-simulation/lib/features/scope-filter/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  showScopes: [ 'type', _ShowScopes__WEBPACK_IMPORTED_MODULE_0__.default ]
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _SimulationState__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SimulationState */ "./node_modules/bpmn-js-token-simulation/lib/features/simulation-state/SimulationState.js");
/* harmony import */ var _element_notifications__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../element-notifications */ "./node_modules/bpmn-js-token-simulation/lib/features/element-notifications/index.js");
/* harmony import */ var _notifications__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../notifications */ "./node_modules/bpmn-js-token-simulation/lib/features/notifications/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  simulationState: [ 'type', _SimulationState__WEBPACK_IMPORTED_MODULE_0__.default ]
});
...
function ToggleMode(
  ...
  eventBus.on('diagram.init', () => {
    ...
    this._palette = (0,min_dom__WEBPACK_IMPORTED_MODULE_1__.query)('.djs-palette', this._canvas.getContainer());
...
ToggleMode.prototype._init = function() {
  ...
  min_dom__WEBPACK_IMPORTED_MODULE_1__.event.bind(this._container, 'click', () => this.toggleMode());
...
ToggleMode.prototype.toggleMode = function(active = !this._active) {
  ...
  if (active) {
    ...
    (0,min_dom__WEBPACK_IMPORTED_MODULE_1__.classes)(this._canvasParent).add('simulation');
    (0,min_dom__WEBPACK_IMPORTED_MODULE_1__.classes)(this._palette).add('hidden');
  } else {
    this._container.innerHTML = 'Token Simulation <span class="toggle"><i class="fa fa-toggle-off"></i></span>';

    (0,min_dom__WEBPACK_IMPORTED_MODULE_1__.classes)(this._canvasParent).remove('simulation');
    (0,min_dom__WEBPACK_IMPORTED_MODULE_1__.classes)(this._palette).remove('hidden');
  ...
  this._eventBus.fire(_util_EventHelper__WEBPACK_IMPORTED_MODULE_0__.TOGGLE_MODE_EVENT, {
    active
  });
...
function TokenCount(
  ...
  eventBus.on(_util_EventHelper__WEBPACK_IMPORTED_MODULE_1__.SCOPE_FILTER_CHANGED_EVENT, event => {
    ...
    const allElements = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.queryAll)('.token-count[data-scope-id]', overlays._overlayRoot);
...
TokenCount.prototype.addTokenCounts = function(element) {
  ...
  if ((0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:MessageFlow') || (0,_util_ElementHelper__WEBPACK_IMPORTED_MODULE_0__.is)(element, 'bpmn:SequenceFlow')) {
    return;
  }
...
TokenCount.prototype.addTokenCount = function(element, scopes) {
  ...
  const html = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)(`
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _TokenCount__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TokenCount */ "./node_modules/bpmn-js-token-simulation/lib/features/token-count/TokenCount.js");
/* harmony import */ var _scope_filter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../scope-filter */ "./node_modules/bpmn-js-token-simulation/lib/features/scope-filter/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  tokenCount: [ 'type', _TokenCount__WEBPACK_IMPORTED_MODULE_0__.default ]
});
...
/* harmony import */ var _features_editor_actions__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_features_editor_actions__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _features_keyboard_bindings__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_features_keyboard_bindings__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  'toggleMode': [ 'type', _features_toggle_mode_modeler__WEBPACK_IMPORTED_MODULE_2__.default ],
  'tokenSimulationEditorActions': [ 'type', (_features_editor_actions__WEBPACK_IMPORTED_MODULE_3___default()) ],
  'tokenSimulationKeyboardBindings': [ 'type', (_features_keyboard_bindings__WEBPACK_IMPORTED_MODULE_4___default()) ]
});
...
function isInterrupting(element) {
  return (0,_ModelUtil__WEBPACK_IMPORTED_MODULE_0__.getBusinessObject)(element).isInterrupting;
}
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Simulator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Simulator */ "./node_modules/bpmn-js-token-simulation/lib/simulator/Simulator.js");
/* harmony import */ var _behaviors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./behaviors */ "./node_modules/bpmn-js-token-simulation/lib/simulator/behaviors/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  simulator: [ 'type', _Simulator__WEBPACK_IMPORTED_MODULE_0__.default ]
});
...
/* harmony import */ var bpmn_js_token_simulation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! bpmn-js-token-simulation */ "./node_modules/bpmn-js-token-simulation/index.js");
...
(0,camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__.registerBpmnJSPlugin)(bpmn_js_token_simulation__WEBPACK_IMPORTED_MODULE_1__.default);
